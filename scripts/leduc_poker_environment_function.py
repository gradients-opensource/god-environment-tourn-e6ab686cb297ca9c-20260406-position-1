def game_rollout_first_prompt_and_completion(prompts: list[str], trainer, max_turns: int = 30) -> dict[str, list]:
    ...
    if not getattr(game_rollout_first_prompt_and_completion, "initialized", False):
        # Get local rank
        ...
        game_rollout_first_prompt_and_completion.base_url = base_url
        ...
        try:
            ...
            game_rollout_first_prompt_and_completion.initialized = True
    ...
    env_endpoint = game_rollout_first_prompt_and_completion.base_url
